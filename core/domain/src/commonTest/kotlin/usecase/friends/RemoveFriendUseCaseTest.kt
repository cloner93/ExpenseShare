...
class RemoveFriendUseCaseTest : StringSpec({

    val repo = mock(of<FriendsRepository>())

    val useCase = RemoveFriendUseCase(repo)

    "should return Unit when successful" {
        // Arrange
        coEvery { repo.removeFriend("09123456778") }
        ...
        coVerify { repo.removeFriend("09123456778") }.wasInvoked(exactly = 1)
    }
